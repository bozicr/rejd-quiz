...
function DatabaseIco() {
  return (
    ...
    >
      <path d='M4 18V6' stroke='#1C274C' strokeWidth='1.5' strokeLinecap='round' />
      <path d='M20 6V18' stroke='#1C274C' strokeWidth='1.5' strokeLinecap='round' />
      <path
